...
function loadInstrContent() {
    ...
    var instrContent = [
        /* ind0 */ '<p>Hello! Thank you for participating in our study. Please take a moment to adjust your seating so that you can comfortably watch the monitor and use the keyboard. Feel free to dim the lights as well.</p><p>Close the door or do whatever is necessary to <b>minimize disturbance during the experiment</b>. Please also take a moment to silence your phone so that you are not interrupted by any messages mid-experiment. Do <i>not</i> switch to any other tabs or windows until you are complete.</p>',
        /* ind1 */ `<p>A cross will briefly appear in the center of the screen. Then, right after, a figure will appear somewhere on the screen for a short time.</p><p>Your job is simple: after the figure disappears, you will be asked to <b>recreate how long the figure was on the screen</b>. To do so, you will be asked to click and hold a button for the <u>same amount of time</u> the figure was on the screen.</p><p>On the next page, you'll try an example.</p>`,
        /* ind2 */ `<p>As you just experienced, the timing can be tricky. The figures will change throughout the experiment, but your job stays the same.</p><p>Each time a figure disappears, <b>click and hold the button to recreate how long the figure was on the screen.</b></p>`,
